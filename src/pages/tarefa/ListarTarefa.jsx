...
const ListarTarefa = () => {
  ...
  const [tarefa, setTarefa] = useState(null); // Mudança aqui para 'null' em vez de 'undefined'
  const [idTarefaSelecionada, setIdTarefaSelecionada] = useState(null); // Mudança aqui para 'null'
  ...
  return (
    <>
      <Card>
        ...
        <CardActions>
          <Button size="big"  variant="contained" onClick={handleOpen}>Criar Tarefa</Button>
          <Button size="big"  variant="outlined">Cancelar</Button>
        </CardActions>
      </Card>
